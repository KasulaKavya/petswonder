        ...
        <div className="container profile-about bg-light p-5">
            ...
            <div className="row">
                <div className="form-group row col-md-6">
                    ...
                    <input className="ml-1 col-md-12 effect-11" type="text" placeholder="Pet Name" name="petName" value={petName} onChange={e => onChange(e)}/>
                    </div>
                ...
                <div class="col-sm-9 controls">
                <select className="ml-1 col-md-12" name="petGender" value={petGender} onChange={e => onChange(e)}>
                ...
                <div class="col-sm-9 controls">
                <input className="ml-1 col-md-12" type="date" placeholder="Pet Date Of Birth" name="petDob" value={petDob} onChange={e => onChange(e)}/>
                </div>
                </div>
                ...
                <div class="col-sm-9 controls">
                <input className="ml-1 col-md-12" type="text" placeholder="Address1" name="addressLine1" value={addressLine1} onChange={e => detailsChange(e)}/>
                </div>
                </div>
                ...
                <div class="col-sm-9 controls">
                <input className="ml-1 col-md-12" type="text" placeholder="Adress2" name="addressLine2" value={addressLine2} onChange={e => detailsChange(e)}/>
                </div>
                </div>
                ...
                <div class="col-sm-9 controls">
                <input className="ml-1 col-md-12" type="text" placeholder="State" name="state" value={state} onChange={e => detailsChange(e)} />
                </div>
                </div>
                ...
                <div class="col-sm-9 controls">
                <input className="ml-1 col-md-12" type="text" placeholder="City" name="city" value={city} onChange={e => detailsChange(e)}/>
                </div>
                </div>
                ...
                <div class="col-sm-9 controls">
                <input className="ml-1 col-md-12" type="text" placeholder="Area" name="area" value={area} onChange={e => detailsChange(e)} />
                </div>
                </div>
                ...
                <div className="form-group row col-md-6">
                    ...
                    <div class="col-sm-9 controls">
                    <input className="ml-1 col-md-12" type="number" placeholder="Pincode" name="pinCode" value={pinCode} onChange={e => detailsChange(e)}/>
                    </div>
                </div>
