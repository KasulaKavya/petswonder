            ...
            <Navbar bg="dark" expand="lg" variant="dark" fixed="top">
                ...
                <Nav className="ml-auto flex-column flex-wrap">
                    ...
                    <ul class="navbar-nav mb-auto mt-0">
                        {jwt && <Nav.Link className="nav-links" href="/search" style={isActive(history, '/search')}>
                           <i class="fas fa-search"></i>{' '}Search
                        </Nav.Link>}
                        
                        <Nav.Link className="nav-links" href="/search" style={isActive(history, '/search')}>
                        ...
                        {jwt && <Nav.Link className="nav-links" href="/cart" style={isActive(history, '/cart')}><i class="fas fa-shopping-cart"></i>{' '}Cart</Nav.Link>}
                        {jwt && <Nav.Link className="nav-links" href="/profile" style={isActive(history, '/profile')}><i class="fas fa-user-circle"></i>{' '}Account</Nav.Link>}
                        </ul>
                    </div>
                    <ul class="navbar-nav mb-auto mt-0 mr-auto">
                        
                        {jwt && <Nav.Link className="nav-links" onClick={()=>signout(()=>{history.push("/signin");}
                            )} href="/signin" style={isActive(history, '/signin')}>SignOut</Nav.Link>}
                        
                        {!jwt && <Nav.Link className="nav-links" href="/signin" style={isActive(history, '/signin')}>Signin</Nav.Link>}
                        ...
                        {jwt && <Nav.Link className="nav-links" href="/shopping" style={isActive(history, '/shopping')}>Shopping</Nav.Link>}
